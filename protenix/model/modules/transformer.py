    ...
    def __init__(
        ...
        if time_attn:
            self.attention_time = AttentionTime(
                has_s=True, n_heads=n_heads, c_a=c_a, c_s=c_s, c_z=c_z, biasinit=biasinit, causal_mask=causal_mask
            )
    ...
    def __init__(
        ...
        for _ in range(n_blocks):
            block = DiffusionTransformerBlock(
                n_heads=n_heads, c_a=c_a, c_s=c_s, c_z=c_z, time_attn=time_attn, causal_mask=causal_mask
            )
